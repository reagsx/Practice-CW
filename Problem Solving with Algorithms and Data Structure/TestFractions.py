# Used https://github.com/mbhushan/ps-algods-py/tree/master/chap1-Introduction
# as a test file and as an example

from fractions import Fraction
from frac_utilities import readInt
...
def main():
    ...
    print ("Numerator of first fraction: {}".format(x.getNum()))
    print ("Denominator of first fraction: {}".format(x.getDen()))
